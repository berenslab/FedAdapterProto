...
def args_parser():
    ...
    parser.add_argument('--alg', type=str, default='fedproto', 
                        help="algorithms")
    ...
    parser.add_argument('--test_ep', type=int, default=10, 
                        help="num of test episodes for evaluation")
    ...
    parser.add_argument('--ld', type=float, default=1, 
                        help="weight of proto loss")
    parser.add_argument('--alpha_ce', type=float, default=1, 
                        help="weight of CE loss")
    parser.add_argument('--alpha_kl', type=float, default=0.1, 
                        help="weight of KL loss")
    parser.add_argument('--gamma_proto', type=float, default=0.5, 
                        help="weight of KL loss")
    parser.add_argument('--ft_round', type=int, default=10, 
                        help="round of fine tuning")
